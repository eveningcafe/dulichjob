		...
		<div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel-body">
                ...
                <div style="border-style: solid;border-width: 1px;">
                    <div>
            		    <a class="col-md-4" href="{{url('viewInfoCty',$cty_id[$i])}} ">Tên công ty: <?php echo $ten_cty[$i]; ?></a>
            	    </div>
            	    <div>
            		    <a class="col-md-4" href="{{url('viewInforTour',$tour_id[$i])}}">Chi tiết tour</a>
            	    </div>
                    <div>
                        <label class=" col-md-4 control-label">Địa điểm: <?php echo $dia_diem[$i]; ?> </label>
